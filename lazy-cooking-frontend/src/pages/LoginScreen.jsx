                                        ...
                                        <div className="row mt-2">
                                            ...
                                            <div className="col-6 get-in-touch">
                                                ...
                                                <Form onSubmit={this.handleSubmit} className="login-form">
                                                    ...
                                                    <Form.Item>
                                                        {getFieldDecorator('password', {
                                                            rules: [{ required: true, message: 'Vui Lòng nhập mật khẩu lớn hơn 6 ký tự!', min: 6, }],
                                                        })(
                                                            <Input
                                                ...
                                                <div >
                                                    <Button block type='danger'
                                                        onClick={this.handleGGLogin} >
                                                        <Icon type="google" /> Đăng nhập với tài khoản Google</Button>
                                                </div>
                                            </div>
                                            <div className="col-3"></div>
                                        </div>
...
const WrappedLoginScreen = Form.create({ name: "validate_other" })(
    LoginScreen
);
